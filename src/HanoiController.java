...
public class HanoiController {
    ...
    public Stack<String> getPilaTorreA() {
        return PilaTorreA;
    }
    ...
    public void ResolverPorRecursividad(int n,Stack<String> PilaTorreOrigen,Stack<String> PilaTorreAuxiliar,Stack<String> PilaTorreDestino) {
        ...
        PilaTorreOrigen.sort(((s2, s1) -> s1.compareTo(s2) )); //Ordeno la pila de inicio para tener el primer disco arriba del stack
        PilaTorreDestino.sort((s2, s1) -> s1.compareTo(s2)); //Ordeno la pila de destino para tener el primer disco arriba del stack
        PilaTorreAuxiliar.sort((s2, s1) -> s1.compareTo(s2)); //Ordeno la pila de destino para tener el primer disco arriba del stack
